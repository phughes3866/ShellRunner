...
###### "sideBarMenuOn": true / false,  "contextMenuOn": true / false

These two settings can be used to show (true) or hide (false) the *ShellRunner Commands* entry in the menus. The default (installation) settings are to show the command in both the Side Bar and the Context Menu.
